...
.msg_en <- list(
    callable_invalid_identifier = "Native routine identifier must be a length-1 character vector or external pointer",
    unsupported_input_type = "Unsupported input type '%s'",
    array_img_invalid_dimensions = "argument 'img' must have 3 dimensions (height, width, bands)",
    ...
    unused_array_arguments = "Unused arguments for array input: %s",
    plot_array_invalid_dims = "argument 'x' must be a 3D array with dimensions (height, width, bands)",
    plot_array_must_be_numeric = "argument 'x' must be a numeric array",
    plot_rgb_params_missing = "Parameters 'r', 'g', and 'b' must all be supplied together",
    plot_rgb_params_not_integer = "Parameters 'r', 'g', and 'b' must be integer indices",
    plot_rgb_invalid_index_array = "Invalid RGB band index. Array has %d bands.",
    plot_band_single_integer = "'band' must be a single integer index",
    plot_band_invalid_index_array = "Invalid 'band' index (%d). Array has %d bands.",
    stretch_method_invalid = "argument 'stretch' has an invalid method",
    ...
    argument_must_be_spatraster = "argument '%s' must be a 'SpatRaster' object",
    ...
    unused_spatraster_arguments = "Unused arguments for SpatRaster input: %s",
    spatraster_extract_failed = "Unable to extract pixel values from the SpatRaster input.",
    raster_invalid_index = "invalid band index; raster has %d bands.",
    plot_rgb_invalid_index_raster = "Invalid RGB band index. Raster has %d bands.",
    plot_band_invalid_index_raster = "argument 'band' has invalid band index.",
    plot_segments_single_band = "raster segments must have one band",
    plot_core_invalid_x = "argument 'x' is not a SpaceRaster",
    seg_invalid_type = "argument 'seg' must be a SpatRaster or SpatVector",
    ...
    grid_img_min_dimensions = "argument 'img' must have at least one row and one column",
    grid_spacing_empty = "argument 'spacing' cannot be empty",
    ...
    grid_spatraster_missing_crs = "SpatRaster must define a CRS to compute geographic coordinates",
    grid_latlong_non_finite = "Seed latitude/longitude must be finite values",
    ...
    check_seeds_matrix_two_columns = "argument '%s' must have exactly two columns",
    ...
    seeds_out_of_bounds = "argument 'seeds' must lie within the image bounds",
    ...
    img_must_be_integer_array = "argument 'img' must be an integer array",
    img_must_be_integer_array_three_dimensions = "argument 'img' must be an integer array with three dimensions",
    img_must_be_numeric_array = "argument 'img' must be a numeric array",
    img_must_have_dimensions = "argument 'img' must have dimensions",
    img_must_be_numeric_array_three_dimensions = "argument 'img' must be a numeric array with three dimensions",
    img_dimensions_positive_integers = "argument 'img' dimensions must be positive integers",
    ...
    seeds_lonlat_requires_crs = "Cannot use (lon, lat) seeds with non-spatial data",
    snic_args_must_be_list = "argument 'snic_args' must be a list",
    snic_args_named_list = "argument 'snic_args' must be a named list",
    snic_args_reserved = "argument 'snic_args' cannot override reserved parameters: %s",
    img_must_be_atomic = "'img' must be an atomic R object",

...
.msg_en <- list(
    ...
    array_img_invalid_dimensions = "argument 'x' must have 3 dimensions (height, width, bands)",
    ...
    img_must_be_integer_array = "argument 'x' must be an integer array",
    img_must_be_integer_array_three_dimensions = "argument 'x' must be an integer array with three dimensions",

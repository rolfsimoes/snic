...
```{r array-image-rgb, fig.width = 8, fig.height = 6, fig.cap = "An RGB image of a clownfish."}
...
```{r array-image-lab-rgb, fig.width = 7, fig.height = 4, fig.cap = "Comparison of the L, a, b channels (Lab color space) with the R, G, B channels (RGB color space)."}
...
```{r array-image-seg, fig.width = 8, fig.height = 6, fig.cap = "The clownfish image with superpixel segmentation boundaries overlaid."}
# Prepare figure layout
par(mfrow = c(1, 1))
...
```{r array-image-grid-types, fig.width = 8, fig.height = 12, fig.cap = "Superpixel segmentation results on the clownfish image. Rows correspond to different seed grid types (rectangular, diamond, hexagonal, random) and columns to different compactness values (0.1 and 0.5)."}

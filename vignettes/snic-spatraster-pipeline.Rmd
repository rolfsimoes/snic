...
```{r plot-s2, fig.width = 6, fig.height = 4.5, fig.alt = "A false-color composite of a Sentinel-2 scene, showing vegetation in shades of green and urban areas in shades of purple."}
...
```{r plot-seg, fig.width = 6.5, fig.height = 4.5, fig.alt = "The Sentinel-2 false-color composite with superpixel segmentation boundaries overlaid in yellow and seed points marked with cyan crosses."}
snic_plot(
  s2,
  r = "B08", g = "B04", b = "B02",
  stretch = "lin",
...
```{r grid-types-plot, fig.width = 7.5, fig.height = 12, fig.alt = "A 4x2 grid of plots showing superpixel segmentation results on the Sentinel-2 scene. Rows correspond to different seed grid types (rectangular, diamond, hexagonal, random) and columns correspond to different compactness values (0.1 and 0.4)."}
...
```{r hex-seeds-res-plot, fig.width = 8, fig.height = 8, fig.alt = "A 2x2 grid of plots showing superpixel segmentation results on the Sentinel-2 scene at different aggregation factors (1, 2, 4, 8)."}

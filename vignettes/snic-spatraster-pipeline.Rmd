...
```{r plot-s2, fig.width = 8, fig.height = 6, fig.cap = "A false-color composite of a Sentinel-2 scene."}
...
```{r plot-seg, fig.width = 8, fig.height = 6, fig.cap = "The Sentinel-2 false-color composite with superpixel segmentation boundaries overlaid in yellow and seed points marked with cyan crosses."}
snic_plot(
  s2,
  r = "B08", g = "B04", b = "B02",
  stretch = "lin",
...
```{r grid-types-plot, fig.width = 8, fig.height = 12, fig.cap = "Superpixel segmentation results on the Sentinel-2 scene. Rows correspond to different seed grid types (rectangular, diamond, hexagonal, random) and columns correspond to different compactness values (0.1 and 0.4)."}
...
```{r hex-seeds-res-plot, fig.width = 7, fig.height = 6.5, fig.cap = "Superpixel segmentation results on the Sentinel-2 scene at different spatial resolutions (60 m, 120 m, 240 m, 480 m)."}

...
```{r quick-start, eval = TRUE, fig.alt = "RGB composite of the Sentinel-2 subset with SNIC superpixel boundaries."}
library(snic)
library(terra)
...
```{r seed-strategies, eval = TRUE, fig.width = 8, fig.height = 7, fig.cap = "Seed placement strategies on the Sentinel-2 example (spacing = 30)."}
set.seed(42)
...
```{r segmentation-plot, eval = TRUE, fig.alt = "SNIC segmentation output overlaid on the Sentinel-2 composite."}

...
[![Code Coverage](https://codecov.io/gh/rolfsimoes/snic/branch/dev/graph/badge.svg)](https://app.codecov.io/gh/rolfsimoes/snic?branch=dev)
<!-- badges: end -->
...
```{r quick-start, fig.width = 8, fig.height=6, fig.cap = "RGB composite of the Sentinel-2 subset with SNIC superpixel boundaries."}
library(snic)
library(terra)
...
```{r seed-strategies, eval = TRUE, fig.width = 9, fig.height = 7, fig.cap = "Seed placement strategies on the Sentinel-2 example (spacing = 30)."}
set.seed(42)
...
```{r segmentation-plot, eval = TRUE, fig.width = 8, fig.height = 7, fig.cap = "SNIC segmentation output overlaid on the Sentinel-2 composite."}
...
```{r segmentation-animation, echo = TRUE, results = 'asis'}
